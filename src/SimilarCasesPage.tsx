    ...
    <div className="mx-auto max-w-6xl px-7 py-8">
      ...
      {mode === "text" && (
        <p className="mb-6 text-[12.5px] leading-relaxed text-[var(--ink-muted)]">
          ...
          Weak matches (similarity below 0.50) are hidden.
        </p>
      )}
    ...
    <>
      ...
      {isEmpty ? (
        ...
        >
          ...
          <p className="mt-1 text-[12.5px] leading-relaxed text-[var(--ink-muted)]">
            {result.kind === "text"
              ? "No FIR narratives scored at or above the similarity floor (0.50) for this phrase. Try a more specific modus description, or switch to FIR id."
